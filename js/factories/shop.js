(function() {
  ...
  angular
    .module("storeFront")
    .factory("storeInventory", storeInventory);
    ...
    var localStorageKey = "storeFront-inventory";
    ...
    function updateInventory(inventory){
      console.log('should save', inventory);
      localStorage.setItem(localStorageKey, angular.toJson (inventory));
    }

    function storeInventory(){
      console.log("inside storeInventory");
      return {
